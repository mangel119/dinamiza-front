...
import { Convcardf } from "@/widgets/cards/convcardf.jsx";

export function Fondo() {
  return (
    <>
      <section className="relative block h-[50vh]">
        <div className="bg-profile-background absolute top-0 h-full w-full bg-[url('/img/fondo.jpeg')] bg-cover bg-center" />
